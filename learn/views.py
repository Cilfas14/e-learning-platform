...
def face_template2(request):
    ...
    geolocator = Nominatim(user_agent="my-django-app-zilfa-2025")
...
def TakeImages(request):
    if request.method == 'POST':
        ...
        if ((name.isalpha()) or (' ' in name)):
            ...
            harcascadePath = "C:\\Users\\DELL\\OneDrive\\Desktop\\learning\\learn\\haarcascade_frontalface_default.xml"
            ...
            while (True):
                ...
                for (x, y, w, h) in faces:
                    ...
                    serial = km.id
                    cv2.imwrite("C:\\Users\\DELL\\OneDrive\\Desktop\\learning\\learn\\TrainingImage\\" + name + "." + str(serial) + "." + str(km.email) + "." + str(sampleNum) + ".jpg",gray[y:y + h, x:x + w])
                    # display the frame
            ...
            faces, ID = getImagesAndLabels("C:\\Users\\DELL\\OneDrive\\Desktop\\learning\\learn\\TrainingImage")
            recognizer.train(faces, np.array(ID))
            recognizer.save("C:\\Users\\DELL\\OneDrive\\Desktop\\learning\\learn\\Trainner.yml")
...
def TrackImages(request):
    ...
    try:
        recognizer.read("C:\\Users\\DELL\\OneDrive\\Desktop\\learning\\learn\\Trainner.yml")
    except:
...
def sse_view(request):
    return render(request,'sse_vieww.html')

def sse_view1(request):
    def event_stream():
        while True:
            time.sleep(2)  # Simulate server updates every 2 seconds
